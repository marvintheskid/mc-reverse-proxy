...
import static gbx.proxy.utils.Tuple.tuple;
...
public interface PacketTypes {
    ...
    final class Cache {
        ...
        private static final List<Tuple<Version, String>> MAIN_PROTOCOL_VERSIONS = Stream.of(
            tuple(Version.V1_7_2, "V1_7_2"),
            tuple(Version.V1_8, "V1_8"),
            tuple(Version.V1_9, "V1_9"),
            tuple(Version.V1_12, "V1_12"),
            tuple(Version.V1_12_1, "V1_12_1"),
            tuple(Version.V1_13, "V1_13"),
            tuple(Version.V1_14, "V1_14"),
            tuple(Version.V1_15_2, "V1_15_2"),
            tuple(Version.V1_16, "V1_16"),
            tuple(Version.V1_16_2, "V1_16_2"),
            tuple(Version.V1_17, "V1_17")
        ).toList();
